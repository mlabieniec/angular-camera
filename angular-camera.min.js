...
t.module("angular-camera",[]).directive("camera",function(){return{template:"<div ng-transclude></div>",transclude:!0,replace:!0,restrict:"E",scope:{rtc:"=",options:"="},link:function(e,t,n){e.rtc=new CamCapture(e.options)}}})}(window,window.angular)
